  ...
  return (
    <div className='absolute bottom-0 w-full left-0 rounded-t-md z-10'>
        <form className="w-full h-[35px] flex items-center justify-center" onSubmit={onSubmitFormHandler}>
          ...
          <button className=' absolute right-[5px] w-[25px] h-[25px] rounded-md' type='submit'>
            &nbsp; 
            <SvgIcon className=" absolute top-0 right-0" name="add" color="rgba(152, 255, 152, 1)" size={24}/>
          </button>
        </form>
    </div>
  )
